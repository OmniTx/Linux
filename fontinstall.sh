...
#-------------------------------
#
#	Created By Imran Ahammed
#
# Date: 2021.02.04 11.36PM
#	Get me by itsimran.official001@gmail.com if you want to ...
#------------------------------------------------------------------------------

echo "Welcome to Bangla Font Installer from Imran Ahmed !!!"
echo "------------------------------------"
...
then
    ...
    echo -e "type Sudo SU to get administrator privilege.\n";\
    exit;
fi
...
downloadUrls=("https://raw.githubusercontent.com/OmniTx/Linux/main/banglafonts.tar.gz")
...
if [ $USER = "root" ]; then
  fontsDir="/root/.fonts/imrBanglaFonts"
fi
if [ $USER != "root" ]; then
  fontsDir="/home/$USER/.fonts/imrBanglaFonts"
fi
echo -e "\n"
if [ ! -d "$fontsDir" ]; then
  mkdir -p $fontsDir;
else
  echo -e "Upgrading bangla fonts provided by me....\n";
  rm -r $fontsDir;
  mkdir -p $fontsDir;
fi
...
echo -e "Script is Created by Imran Ahammed\n"
echo -e "YouTube: Immekun"
